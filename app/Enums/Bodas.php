...
enum Bodas: int
{
    ...
    public function bodas(): string
    {
        return match ($this) {
            ...
            self::TRIGO => 'Bodas de Trigo/Couro',
            self::FLORES => 'Bodas de Flores e Frutas',
            self::MADEIRA => 'Bodas de Madeira/Ferro',
            self::PERFUME => 'Bodas de Perfume/Açúcar',
            self::LATAO => 'Bodas de Latão/Lã',
            self::PAPOULA => 'Bodas de Papoula/Barro',
            self::CERAMICA => 'Bodas de Cerâmica/Vime',
            self::ESTANHO => 'Bodas de Estanho/Zinco',
            self::ACO => 'Bodas de Aço',
            self::ONIX => 'Bodas de Ônix/Seda',
            self::LINHO => 'Bodas de Linho/Renda',
            ...
            self::CRETONE => 'Bodas de Cretone/Água Marinha',
            ...
            self::TELURITA => 'Bodas de Telurita/Alecrim',
